...
public class ProvideSoupState extends StateMachine {
	public void process(DistributorMachine distributorMachine){
		System.out.println("-> Remplir soupe en poudre");
		ProgressTime.start(1);
		distributorMachine.setStateMachine(new ProvideVermicelliState());
	}
}
